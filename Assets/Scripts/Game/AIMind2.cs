...
public partial class GameModel
{
    private class AIMind2 : AIMind
    {
        ...
        private const double ADECAY = 0.05;
        private const double QDECAY = 0.2;
        ...
        ThoughtQueue thoughtQueue = new ThoughtQueue(4);
        ...
        private class Thought
        {
            ...
            //next thoughts
            public AbsoluteThoughtQueue nextThoughts = new AbsoluteThoughtQueue(5);
        ...
        private class State
        {
            ...
            //next thoughts
            public AbsoluteThoughtQueue nextThoughts = new AbsoluteThoughtQueue(4);
        ...
        public override CharacterAction getNextAction()
        {
            ...
            double tftImportanceFactor = 0.5;
            for (int i = 1; i < SML; i++)
            {
                thoughtMemory[i].nextThoughts.bump(thoughtMemory[i - 1], tftImportanceFactor * staminaChange * System.Math.Pow(0.5, (double)i - 1.0));
            }
            for (int i = 0; i < SML; i++)
            {
